...
export const MENU_SIDEBAR: MenuConfig = [
  ...
  // removed in imaderoi: Store - Admin
  // removed in imaderoi: Store - Services
  // removed in imaderoi: AI Promt
  // removed in imaderoi: Invoice Generator
  // --- Imaderoi additions ---
  { heading: 'Tracking' },
  {
    title: 'Tracking',
    // icon opcional aqui; manter sem importar ícone evita erro
    path: '/tracking',
    children: [
      { title: 'Domains', path: '/tracking/domains' },
      { title: 'Entities', path: '/tracking/entities' },
      { title: 'Integrations', path: '/tracking/integrations' },
      { title: 'Campaigns', path: '/tracking/campaigns' },
    ],
  },
];
